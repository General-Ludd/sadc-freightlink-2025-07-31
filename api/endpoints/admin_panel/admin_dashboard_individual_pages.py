        ...
        if financial_account:
            financial_account_data = {
                ...
                "financial_procedure": {
                    ...
                    "statement_cycle": financial_account.statement_cycle,
                    "statement_days": financial_account.statement_days,
                    "statement_generation": financial_account.statement_generation,
                    "statement_cutoff_type": financial_account.statement_cutoff_type,
                    "finance_department_email": financial_account.finance_department_email,
                    "pod_required": financial_account.pod_required,
                    "pod_submission_method": financial_account.pod_submission_method,
                    "pod_submission_email": financial_account.pod_submission_email,
                    "pod_cutoff_days": financial_account.pod_cutoff_days,
                    "pod_special_requirements": financial_account.pod_special_requirements,
                    "missed_cutoff_action": financial_account.missed_cutoff_action,
                    "payment_run_type": financial_account.payment_run_type,
                    "payment_run_days": financial_account.payment_run_days,
                    "payment_run_rule": financial_account.payment_run_rule,
                    "fixed_payment_day": financial_account.fixed_payment_day,
                    "payment_run_weekday": financial_account.payment_run_weekday,
                    "nth_week": financial_account.nth_week,
                    "payment_business_days_only": financial_account.payment_business_days_only,
                    "grace_days": financial_account.grace_days,
                },
            }
