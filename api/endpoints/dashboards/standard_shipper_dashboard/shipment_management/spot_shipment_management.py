    ...
    try:
        ...
        return {
            "shipment_details": {
                ...
                "under_bond": shipment.under_bond or False,
                "rib_requirements": shipment.rib_requirements or False,
    ...
    try:
        ...
        return {
            "shipment_details": {
                ...
                "temperature_control": shipment.temperature_control,
                "hazardous_materials": shipment.hazardous_materials,
                "under_bond": shipment.under_bond if shipment.under_bond is not None else False,
                "rib_requirements": shipment.rib_requirements if shipment.rib_requirements is not None else False,
                "minimum_git_cover_amount": shipment.minimum_git_cover_amount,
                "minimum_liability_cover_amount": shipment.minimum_liability_cover_amount,
                "packaging_quantity": shipment.packaging_quantity,
                "packaging_type": shipment.packaging_type,
