...
from api.endpoints.admin_panel.admin_dashboard_pages_functions import financial_account, company
...
app.include_router(financial_account.router, prefix="/api", tags=["Admin Financial Account Management"])
