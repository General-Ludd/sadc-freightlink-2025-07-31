...
class POWER_SHIPMENT_EXCHANGE(Base):
    ...
    trailer_return_instructions = Column(String)
    ...
    offer_rate = Column(Integer)
    backed_offer_rate = Column(Integer, nullable=False) ### Update in database
    suggested_rate = Column(Integer)
