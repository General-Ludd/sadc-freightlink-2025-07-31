...
class BrokerageLedger(Base):
    ...
    carrier_payable = Column(Integer, nullable=True)
    load_invoice_id = Column(Integer, nullable=True)
    load_invoice_due_date = Column(Date, nullable=True)
    load_invoice_status = Column(String, nullable=True)
...
class FinancialAccounts(Base):
    ...
    directors_first_name = Column(String, nullable=True)
    directors_last_name = Column(String, nullable=True)
    directors_nationality = Column(String, nullable=True)
    directors_id_number = Column(String, nullable=True)
    directors_home_address = Column(String, nullable=True)
    directors_phone_number = Column(String, nullable=True)
    directors_email_address = Column(String, nullable=True)
...
class CarrierFinancialAccounts(Base):
    ...
    directors_nationality = Column(String, nullable=True)
    directors_id_number = Column(String, nullable=True)
    directors_address = Column(String, nullable=True)
    directors_phone_number = Column(String, nullable=True)
    directors_email_address = Column(String, nullable=True)
    bank_name = Column(String, nullable=True)
...
class Brokers_Brokerage_Transactions(Base):
    ...
    per_shipment_platform_booking_amount = Column(Integer)
    contract_platform_booking_amount = Column(Integer)
    per_shipment_profit = Column(Integer)
    contract_profit = Column(Integer)
    created_at = Column(DateTime(timezone=True), default=get_sast_time)
    updated_at = Column(DateTime(timezone=True), default=get_sast_time, onupdate=get_sast_time)