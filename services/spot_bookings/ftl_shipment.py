...
def admin_create_client_ftl_shipment(
    ...
    for truck_number in range(number_of_trucks):
        ...
        loadboard_data = LoadBoardEntryCreate(
            ...
            origin_country=origin_country,
            origin_region=origin_region,
            stop_1_address=shipment.stop_1_address if shipment.stop_1_address else None,
            stop_2_address=shipment.stop_2_address if shipment.stop_2_address else None,
            stop_3_address=shipment.stop_3_address if shipment.stop_3_address else None,
            stop_4_address=shipment.stop_4_address if shipment.stop_4_address else None,
            stop_5_address=shipment.stop_5_address if shipment.stop_5_address else None,
            destination_address=shipment_data.destination_address,
            complete_destination_address=complete_destination_address,
            destination_city_province=destination_city_province,
            destination_country=destination_country,
            ...
            pickup_phone_number=pickup_contact_data.phone_number,
            pickup_email=pickup_contact_data.email,
            stop_1_facility_id=shipment.stop_1_facility_id if shipment.stop_1_facility_id else None,
            stop_2_facility_id=shipment.stop_2_facility_id if shipment.stop_2_facility_id else None,
            stop_3_facility_id=shipment.stop_3_facility_id if shipment.stop_3_facility_id else None,
            stop_4_facility_id=shipment.stop_4_facility_id if shipment.stop_4_facility_id else None,
            stop_5_facility_id=shipment.stop_5_facility_id if shipment.stop_5_facility_id else None,
            delivery_facility_name=dropoff_facility_data.name,
            delivery_scheduling_type=dropoff_facility_data.scheduling_type,
            delivery_start_time=dropoff_facility_data.start_time,
            delivery_end_time=dropoff_facility_data.end_time,
