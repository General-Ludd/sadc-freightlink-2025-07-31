...
#################Create Interim Invoices#####################
        ...
        for _ in range(shipment_data.shipments_per_interval):
            ...
            try:
                shipment_invoice = BillingEngine.generate_shipment_invoice(
                    ...
                    payment_reference=f"FTL Shipment-{sub_shipment.id}",
                    origin_address=sub_shipment.origin_address,
                    destination_address=sub_shipment.destination_address,
    ...
    loadboard_data = FTL_lane_LoadBoard_Entry(
        ...
        shipments_per_interval=shipment_data.shipments_per_interval,
        total_shipments=total_shipments,
        total_slots=shipment.shipments_per_interval,
        per_slot_size=(total_shipments / shipment.shipments_per_interval), 
        available_slots=shipment.shipments_per_interval,
...
def broker_create_dedicated_lane_ftl_shipment(
    ...
    broker_transaction = Brokers_Brokerage_Transactions(
        ...
        per_shipment_consignor_billable=broker_transaction_data.per_shipment_consignor_billable,
        contract_consignor_billable=broker_transaction_data.contract_consignor_billable,
        per_shipment_platform_booking_amount=quote_per_shipment,
        contract_platform_booking_amount=total_shipments_quote,
        per_shipment_profit=int(broker_transaction_data.per_shipment_consignor_billable - quote_per_shipment),
        contract_profit=int(broker_transaction_data.contract_consignor_billable - total_shipments_quote)
    )
