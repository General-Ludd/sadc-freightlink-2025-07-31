...
def create_ftl_shipment_exchange(
        db: Session,
    ...
    shipment = FTL_SHIPMENT_EXCHANGE(
        type="FTL",
        ...
        offer_price=shipment_data.offer_price,
        backed_offer_price=shipment_data.offer_price * 0.90,
    ...
    loadboard_entry = Exchange_Ftl_Load_Board(
        ...
        minimum_liability_cover_amount=shipment_data.minimum_liability_cover_amount,
        distance=distance,
        shipment_rate=shipment.backed_offer_price,
        rate_per_km=rate_per_km,
        rate_per_ton=rate_per_ton,
        payment_terms=financial_account.payment_terms,
        payment_date=BillingEngine.get_next_billing_date(financial_account.payment_terms, shipment.pickup_date),
        required_truck_type=shipment_data.required_truck_type,
        equipment_type=shipment_data.equipment_type,
        trailer_type=shipment_data.trailer_type,
        trailer_length=shipment_data.trailer_length,
...
###################################################################################################
############################################Broker FTL Exchange Create#############################
###################################################################################################

def broker_access_create_ftl_shipment_exchange(
        db: Session,
    ...
    shipment = FTL_SHIPMENT_EXCHANGE(
        ...
        allow_carrier_to_book_at_current_or_lower_offer_rate=shipment_data.allow_carrier_to_book_at_current_or_lower_offer_rate,
        offer_price=shipment_data.offer_price,
        consignor_billable=shipment_data.consignor_billable,
        backed_offer_price=shipment_data.offer_price * 0.90,
        suggested_price=quote_per_shipment,
        payment_terms=financial_account.payment_terms,
        route_preview_embed=route_preview_embed,
